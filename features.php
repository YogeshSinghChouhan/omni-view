...
<div class="container" align="left">
  ...
  <p><strong> OmniView </strong>is an online web conferencing platform, built specific for the purpose to save time and learn more, ie. to host and attend, classes and meetings, at a virtual level thus making the best use of the internet.</p>
  ...
  <table width="777" height="201" border="0" align="center" cellpadding="5" cellspacing="5">
    <tr>
      ...
      <td width="527">OmniView is a user project, and we allow multiple users from different locations to simultaneously create and host their classes or meetings live without any problem.</td>
    </tr>
    <tr>
