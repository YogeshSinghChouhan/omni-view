...
<title><?php echo $title; ?> | OmniView</title>
...
<div class="floatl padr10">
  <h1><a href="<?php echo $roomkey;?>"><img src="../images/logo.png" alt="OmniView Home" width="100" height="30" border="0" title="Home"/></a></h1>
</div>
...
<div class="pad5">
	<div class="padl5 marb10">
        ...
        <div class="floatl marl10" id="video_container"><a href="run.html" ><img src="images/Play_Icon-360x240.jpg" width="360" height="240" ></a></div>
